...
export const GallerySection = () => {
  ...
  const goPrev = useCallback(() => {
    setLightboxIndex((i) =>
      i !== null ? (i - 1 + previewImages.length) % previewImages.length : null,
    );
  }, []);

  const goNext = useCallback(() => {
    setLightboxIndex((i) =>
      i !== null ? (i + 1) % previewImages.length : null,
    );
  }, []);
      ...
      <section className="section-padding bg-muted">
        <div className="container-wide">
          <SectionHeader
            ...
            description="A glimpse into the lives we're transforming across our programs in Nakuru, Kenya."
          />
            ...
            >
              ...
              <div className="mt-4 text-center">
                ...
                <p className="text-white/60 text-sm mt-1">
                  {previewImages[lightboxIndex].category} &nbsp;·&nbsp;{" "}
