...
const programs = [
  { name: "Scholarships", path: "/programs#scholarship" },
  { name: "Mentorship", path: "/programs#mentorship" },
  { name: "Digital Literacy", path: "/programs#digital" },
  { name: "Environment Preservation", path: "/programs#environment" },
];

const socialLinks = [
  {
    name: "LinkedIn",
    url: "https://www.linkedin.com/company/african-transformative-voice/",
    icon: (
  ...
  {
    name: "Instagram",
    url: "https://www.instagram.com/africantransformative",
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
  ...
  {
    name: "Facebook",
    url: "https://www.facebook.com/africantransformativevoice",
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="mt-16 pt-8 border-t border-primary-foreground/20">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-primary-foreground/60 text-sm">
              © {new Date().getFullYear()} African Transformative Voice. All
              rights reserved.
            </p>
            <p className="text-primary-foreground/60 text-sm">
